...
@Repository //Repository : component보다 데이터처리에 효율적(why? 예외처리포함)
public class BoardDAOSpring { //extends JdbcDaoSupport : bean사용시에는 getTemplate의 객체 리턴이 없으므로 부모상속 X 
...
//   private final String BOARD_INSERT = "insert into board(seq, title, writer, content) values(?, ?, ?, ?)";
   ...
   //getJdbcTemplate()메소드가 JdbcTemplate 객체를 리턴하려면, 부모클래스의 setDataSource() 메소드를 호출하여 데이터 소스 객체를 의존성 주입 해야 한다.
   /*
