...
public class BoardController {
	...
	*/
	...
	// 글 상세 조회
		...
		public String getBoard(BoardVO vo, BoardDAO boardDAO, Model model) { // ModelAndView getBoard(동일, ModelAndView mav)
			model.addAttribute("board", boardDAO.getBoard(vo)); 	// Model정보 저장 : "board"로 저장(현재 글 상세조회는 수정 메소드 전에 먼저 실행되서 상세창에서 수정가능하다)
	...
	*/	
	...
	// 검색 조건 목록 설정
		...
		@RequestMapping("/getBoardList.do")
		 public String getBoardList(BoardVO vo, BoardDAO boardDAO, Model model) { // ModelAndView getBoardList(동일, ModelAndView mav)
